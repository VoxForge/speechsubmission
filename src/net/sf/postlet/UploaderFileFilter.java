...
public class UploaderFileFilter extends FileFilter {
	...
	private Hashtable<String, UploaderFileFilter> filters = null;
	private String description = null;
	private String fullDescription = null;
	private boolean useExtensionsInDescription = true;

	public UploaderFileFilter() {
	this.filters = new Hashtable<String, UploaderFileFilter>();
	}
	...
	if(filters == null) {
		filters = new Hashtable<String, UploaderFileFilter>(5);
	}
