...
class LabelLocalizer  {
	...
	private void Russian() {
	     ...
	     disclaimerText = 
	   	 "<html>Апплет загрузки речи VoxForge - Авторское право (C) 2007-2016 VoxForge<br>"
	...
	private void Dutch() {
	     ...
	     disclaimerText = 
	    	 "<html>VoxForge Spraakdonatieprogramma - Copyright (C) 2007-2016 VoxForge<br>"
	...
	private void Spanish() {
	     ...
	     disclaimerText = 
	   	 "<html>VoxForge Applet para donación de voz - Copyright (C) 2008-2016 VoxForge<br>"
	   	 +"This program comes with ABSOLUTELY NO WARRANTY; without even the implied<br> "
	   	 +"warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  For<br>" 
	...
	private void Greek() {
        ...
        disclaimerText =           
           "<html>VoxForge Applet Συλλογής Ομιλίας - Copyright (C) 2007-2016 VoxForge<br>"
	...
	private void Turkish() {
	     ...
	     disclaimerText = 
	   	 "<html>VoxForge SpeechSubmission Applet - Copyright (C) 2007-2016 VoxForge<br> Bu programın " +
	...
	private void Ukrainian()
	{
         ...
         disclaimerText = 
             "<html>VoxForge SpeechSubmission Applet - Авторське право© 2007-2016 VoxForge<br>"
	...
	private void Persian() {
	     ...
	     genderPanelLabel = "جنسیت";
	     genderSelection = new String [3];
	     genderSelection[0] = pleaseSelect;   
	     genderSelection[1] = "مذکر";    
	     genderSelection[2] = "مونث"; 
   
	     ageRangePanelLabel = "رده سنی";
	     ageSelection = new String [4];
	     ageSelection[0] = pleaseSelect;  
	     ageSelection[1] = "نوجوان";  
	     ageSelection[2] = "بزرگ‌سال"; 
	     ageSelection[3] = "مسن"; 
	
	     dialectPanelLabel = "لهجه";
	     dialectSelection = new String [21];
	     dialectSelection[0] = pleaseSelect;    
	     dialectSelection[1] = "آبادانی";
	     dialectSelection[2] = "آذری (ترکی)";        
	     dialectSelection[3] = "اراکی";
	     dialectSelection[4] = "اصفهانی"; 
	     dialectSelection[5] = "تهرانی";      
	     dialectSelection[6] = "مشهدی"; 
	     dialectSelection[7] = "خوزستانی";
	     dialectSelection[8] = "جنوبی"; 
	     dialectSelection[9] = "شیرازی"; 
	     dialectSelection[10] = "شهرکردی";
 	     dialectSelection[11] = "قزوینی";
	     dialectSelection[12] = "قمی";
	     dialectSelection[13] = "کرمانشاهی";
	     dialectSelection[14] = "کرمانی";
	     dialectSelection[15] = "یزدی";
	     dialectSelection[16] = "کازرونی";
	     dialectSelection[17] = "دامغانی";
	     dialectSelection[18] = "کاشانی";
	     dialectSelection[19] = "همدانی";
	     dialectSelection[20] = "سایر";
	    
	     microphonePanelLabel = "نوع میکروفن";
	     microphoneSelection = new String [9];
	     microphoneSelection[0] = pleaseSelect;  
	     microphoneSelection[1] = "میکروفن هدست";    
	     microphoneSelection[2] = "میکروفن هدست یو‌اس‌بی";   
	     microphoneSelection[3] = "میکروفن رومیزی";  
	     microphoneSelection[4] = "میکروفن یو‌اس‌بی رومیزی";  
	     microphoneSelection[5] = "میکروفن سرخود لپ تاپ"; 
	     microphoneSelection[6] = "میکروفن وب کم";
	     microphoneSelection[7] = "میکروفن استودیویی"; 
	     microphoneSelection[8] = "سایر"; 
	    
	     uploadText = "<html>با کلیک کردن روی کلید \"ارسال\"، شما حقوق صدای ضبط شده را به بنیاد نرم‌افزارهای آزاد واگذار می‌نمایید تا <br> "
	        + "تا آن را با پروانه عمومی همگانی گنو منتشر نماید (\"GPL\")" ;


	     uploadButtonLabel = "ارسال";
	    
	     moreInfoText = "برای کسب اطلاعات بیشتر در مورد حق طبع و نشر و پروانه عمومی همگانی گنو اینجا کلیک نمایید";
	     moreInfoButtonLabel = "اطلاعات بیشتر";    
	

	     disclaimerText = 
	   	 "<html>اپلت ارسال صوت وکس فورج - Copyright (C) 2007-2016 VoxForge<br>"
	   	 +"این برنامه بدون هیچ تضمینی برای کارکرد صحیح ارائه می‌شود<br> "
	   	 +"همچنین مناسب بودن آن برای هیچ کار خاصی توصیه نمی‌شود<br>" 
	   	 +"برای اطلاعات بیشتر روی کلیک \"درباره\" کلیک کنید. ";

	     aboutButtonLabel = "درباره";
	    
	     recordButton = "ضبط کردن"; 
	     stopButton = "توقف"; 
	     playButton = "پخش"; 
	     
	     peakWarningLabel =  "هشدار: صدای ضبط شده شاید خیلی بلند باشد"; 
	     sampleGraphFileLabel = "فایل ";
	     sampleGraphLengthLabel = "  طول ";
	     sampleGraphPositionLabel ="  موضعیت ";
	     
	     uploadingMessageLabel = "در حال ارسال...";
	     uploadCompletedMessageLabel = "ارسال با موفقیت انجام شد، از مشارکت شما سپاس‌گزاریم!";
